...
| `fig_3_2b_stateprep_matched_reps_q5_label_v2` | Figure 4-a cache-busting asset with the target/ansatz label box below the plot area | OK | `figures/fig_3_2b_stateprep_matched_reps_q5_label_v2.png` |
