...
| `fig_3_2_depth_dose_benchmark_exact_q5_highres_v3` | Current Figure 2 first-order Compton depth-dose benchmark from `*/final_data_analysis/observables/raw/1d/q50/theta/dose_curve.csv`; in-plot title removed | OK | `figures/fig_3_2_depth_dose_benchmark_exact_q5_highres_v3.png` |
...
| `fig_3_2b_stateprep_matched_reps_q5_seed10_ryrz_cx_hinit_whisker_v3` | Current Notion Figure 4-a with ten-seed min-max whiskers and no bottom condition label | OK | `figures/fig_3_2b_stateprep_matched_reps_q5_seed10_ryrz_cx_hinit_whisker_v3.png` |
...
| `fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4` | Current Figure 5 q-space reps=8 diagnostic for the 5-qubit first-order target with HN-MLP panel reporting KL < 10^-4 | OK | `figures/fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4.png` |
...
| `fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_v1` | Figure 6 same-condition theta-space reps=8 ansatz-only replacement using H + TwoLocal(ry, rz; circular CX) | superseded | `figures/fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_v1.png` |
...
| `fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4` | Current Figure 6 theta-space reps=8 diagnostic for the 5-qubit first-order target with HN-MLP panel reporting KL < 10^-4 | OK | `figures/fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4.png` |
...
| `fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10_v2` | Current Figure 10/renumbered Figure 19 first-order 5-qubit downstream D1(z) reconstruction diagnostic from `experiments/stateprep_qmci_seed10/render_figures_12_13_stateprep_qmci.py` and `experiments/stateprep_qmci_seed10/qmci_reconstruction_iter300/figure13_1d_q50_seed10_qmci.csv`; in-image title removed, caption carries the 1D dose reconstruction description | OK | `figures/fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10_v2.png` |
...
| `fig_3_14_chebyshev_q60_dose` | Current Figure 12-a Chebyshev 1D exact discrete/statevector dose reconstruction reference; not a QPE/QAE phase-register output | OK | `notion_github_hosted_figures/fig_3_14_chebyshev_q60_dose.svg` |
| `fig_3_14_fft_q60_dose` | Current Figure 12-b FFT 1D exact discrete/statevector dose reconstruction reference; not a QPE/QAE phase-register output | OK | `notion_github_hosted_figures/fig_3_14_fft_q60_dose.svg` |
...
| `fig_4_1_first_compton_local_deposition_geant4_6mev_water_500k_depth170_v3` | Current first-Compton Geant4 benchmark asset; in-image figure caption removed so the manuscript caption is carried only by the Notion text block | OK | `figures/fig_4_1_first_compton_local_deposition_geant4_6mev_water_500k_depth170_v3.png` |
...
| `fig_4_4_2d_dose_mae_vs_reps` | Removed from manuscript body after Figure 12/13 and Figure 21 made this diagnostic redundant | superseded | `notion_github_hosted_figures/fig_4_4_2d_dose_mae_vs_reps.svg` |
| `fig_4_5_2d_profile_mae_vs_reps` | Removed from manuscript body after Figure 12/13 and Figure 21 made this diagnostic redundant | superseded | `notion_github_hosted_figures/fig_4_5_2d_profile_mae_vs_reps.svg` |
| `fig_4_6_2d_stateprep_kl_vs_reps` | Removed from manuscript body after Figure 12/13 and Figure 21 made this diagnostic redundant | superseded | `notion_github_hosted_figures/fig_4_6_2d_stateprep_kl_vs_reps.svg` |
...
| `fig_4_7_hn_chebyshev_qae_rmse_three_methods_v3` | `experiments/qae_rmse_three_methods_20260629/run_hn_chebyshev_qae_rmse_three_methods_v3.py`; `experiments/qae_rmse_three_methods_20260629/results/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v3_curves.csv`; `experiments/qae_rmse_three_methods_20260629/results/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v3_manifest.json`; HN-MLP 5-qubit first-order Chebyshev target | OK | `figures/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v3.png`; `figures/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v3.svg` | Replacement Figure 14 diagnostic: real local noiseless qiskit-aer 0.17.2 / qiskit-algorithms 0.4.0 execution for shot amplitude, QPE-QAE+MLE, and IQAE. IQAE uses 512 shots per circuit and epsilon down to 0.005 so the multi-round regime is visible; slopes are -0.50, -1.15, and -0.81. The `q50` substring is retained only in provenance as an internal data-layout compatibility tag; manuscript-visible labels use `5-qubit`. |
| `fig_4_7_q44_chebyshev_best_dose` | Removed from manuscript body after representative reconstruction panels became redundant with Figure 12/13 and Figure 21 | superseded | `notion_github_hosted_figures/fig_4_7_q44_chebyshev_best_dose.svg` |
| `fig_4_7_q44_fft_best_dose` | Removed from manuscript body after representative reconstruction panels became redundant with Figure 12/13 and Figure 21 | superseded | `notion_github_hosted_figures/fig_4_7_q44_fft_best_dose.svg` |
| `fig_4_7_q55_chebyshev_best_profile` | Removed from manuscript body after representative reconstruction panels became redundant with Figure 12/13 and Figure 21 | superseded | `notion_github_hosted_figures/fig_4_7_q55_chebyshev_best_profile.svg` |
| `fig_4_7_q55_fft_best_profile` | Removed from manuscript body after representative reconstruction panels became redundant with Figure 12/13 and Figure 21 | superseded | `notion_github_hosted_figures/fig_4_7_q55_fft_best_profile.svg` |
| `fig_4_7_q66_chebyshev_best_profile` | Removed from manuscript body after representative reconstruction panels became redundant with Figure 12/13 and Figure 21 | superseded | `notion_github_hosted_figures/fig_4_7_q66_chebyshev_best_profile.svg` |
| `fig_4_7_q66_fft_best_profile` | Removed from manuscript body after representative reconstruction panels became redundant with Figure 12/13 and Figure 21 | superseded | `notion_github_hosted_figures/fig_4_7_q66_fft_best_profile.svg` |
