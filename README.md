...
| `fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v2` | Current Figure 5 q-space reps=8 diagnostic using H + TwoLocal(ry, rz; circular CX), with learning trace shown to 3000 iterations | OK | `figures/fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v2.png` |
...
| `fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v2` | Current Figure 6 theta-space reps=8 diagnostic using H + TwoLocal(ry, rz; circular CX), with learning trace shown to 3000 iterations | OK | `figures/fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v2.png` |
