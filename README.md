...
| `fig_4_7_hn_chebyshev_qae_rmse_three_methods_v2` | `experiments/qae_rmse_three_methods_20260629/run_hn_chebyshev_qae_rmse_three_methods_v2.py`; `experiments/qae_rmse_three_methods_20260629/results/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v2_curves.csv`; `experiments/qae_rmse_three_methods_20260629/results/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v2_manifest.json`; HN-MLP 5-qubit first-order Chebyshev target | OK | `figures/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v2.png`; `figures/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v2.svg` | Replacement diagnostic requested by comment: log-log RMSE versus effective sample/oracle budget for shot amplitude, QPE-QAE+MLE, and IQAE using noiseless qiskit-aer AerSimulator/SamplerV2. Slopes are shown in the legend. The `q50` substring is retained only in provenance as an internal data-layout compatibility tag; manuscript-visible labels use `5-qubit`. |
