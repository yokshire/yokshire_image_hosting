...
| `fig_3_2d_qgan_hn_mlp_qubit_integral_convergence` | Matched q50 reps=8 qGAN/HN-MLP distributions coarse-grained by data-qubit resolution | OK | `figures/fig_3_2d_qgan_hn_mlp_qubit_integral_convergence.png` |
