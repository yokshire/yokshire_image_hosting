...
The active paper package is `QMCI_manuscript_v04`. Its authoritative 18-figure,
20-image mapping is recorded in:

- `paper_v04_manifest.json` for exact TeX/hosted hashes;
- `CURRENT_PAPER_ASSETS.md` for the human-readable figure sequence.

The historical table below intentionally retains superseded assets. An `OK`
label in an older row does not override the v04 manifest. In particular, the
compact-Yonsei and ideal matched-budget RMSE figures are no longer in the active
paper sequence; v04 Figures 16--18 are the backend state-preparation, full-circuit
IQAE, and controlled ECR-attribution figures.
...
| `fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4` | Current Figure 14 q-space reps=8 diagnostic for the 5-qubit first-order target with HN-MLP panel reporting KL < 10^-4 | OK | `figures/fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4.png` |
...
| `fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4` | Current Figure 15 theta-space reps=8 diagnostic for the 5-qubit first-order Chebyshev target with HN-MLP panel reporting KL < 10^-4 | OK | `figures/fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v4.png` |
...
| `fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10_v2` | Current Figure 11 first-order 5-qubit downstream D1(z) reconstruction diagnostic from `experiments/stateprep_qmci_seed10/render_figures_12_13_stateprep_qmci.py` and `experiments/stateprep_qmci_seed10/qmci_reconstruction_iter300/figure13_1d_q50_seed10_qmci.csv`; in-image title removed, caption carries the 1D dose reconstruction description | OK | `figures/fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10_v2.png` |
...
| `fig_4_1_first_compton_local_deposition_geant4_6mev_water_500k_depth170_v3` | Current Figure 9 first-Compton Geant4 benchmark asset; in-image figure caption removed so the manuscript caption is carried only by the Notion text block | OK | `figures/fig_4_1_first_compton_local_deposition_geant4_6mev_water_500k_depth170_v3.png` |
