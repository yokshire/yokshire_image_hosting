...
| `fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v3` | Current Figure 5 q-space reps=8 diagnostic for the 5-qubit first-order target using H + TwoLocal(ry, rz; circular CX), with learning trace shown to 3000 iterations | OK | `figures/fig_3_5_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v3.png` |
...
| `fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v3` | Current Figure 6 theta-space reps=8 diagnostic for the 5-qubit first-order target using H + TwoLocal(ry, rz; circular CX), with learning trace shown to 3000 iterations | OK | `figures/fig_3_6_theta_matched_reps8_learning_histograms_seed10_ryrz_cx_hinit_trace3000_v3.png` |
