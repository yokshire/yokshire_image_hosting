...
| `fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10` | Current Figure 10/renumbered Figure 19 first-order 5-qubit downstream D1(z) reconstruction diagnostic from `experiments/stateprep_qmci_seed10/render_figures_12_13_stateprep_qmci.py` and `experiments/stateprep_qmci_seed10/qmci_reconstruction_iter300/figure13_1d_q50_seed10_qmci.csv`; `q50` remains an internal data-layout tag in filenames and source paths | OK | `figures/fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10.png` |
...
| `fig_4_6g_yonsei_compact_backend_feasibility_v1` | `experiments/real_backend_yonsei/render_yonsei_compact_backend_feasibility.py`; saved raw/mitigated IBM Yonsei jobs and local AerSimulator baselines | OK | `figures/fig_4_6g_yonsei_compact_backend_feasibility_v1.png`; `figures/fig_4_6g_yonsei_compact_backend_feasibility_v1.svg` | Compact Section 4 hardware feasibility candidate that absorbs the manuscript-relevant content of the detailed Yonsei backend/noise/mitigation figures. |
