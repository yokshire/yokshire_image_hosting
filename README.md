...
| `fig_4_7_qae_iqae_yonsei_aer_qmci_v1` | `experiments/qae_iqae_yonsei_aer_qmci_20260629/run_qae_iqae_yonsei_aer_qmci.py`; QAE/IQAE curves, metrics, and complexity CSVs | OK | `figures/fig_4_7_qae_iqae_yonsei_aer_qmci_v1.png` | QAE/IQAE estimator comparison target using common trained state-preparation circuits, `8192` state-preparation shots, `8192` estimator shots, QAE `m=8`, and IQAE epsilon `0.01`; distinct from exact reconstruction reference panels. |
