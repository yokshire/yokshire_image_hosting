...
| `fig_4_7_hn_chebyshev_qae_rmse_three_methods_v1` | `experiments/qae_rmse_three_methods_20260629/run_hn_chebyshev_qae_rmse_three_methods.py`; `experiments/qae_rmse_three_methods_20260629/results/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v1_curves.csv`; HN-MLP 5-qubit first-order Chebyshev target | OK | `figures/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v1.png`; `figures/fig_4_7_hn_chebyshev_qae_rmse_three_methods_v1.svg` | New replacement diagnostic requested by comment: log-log RMSE versus effective sample/oracle budget for shot amplitude, QPE-QAE+MLE, and IQAE. The `q50` substring is retained only in provenance as an internal data-layout compatibility tag; manuscript-visible labels use `5-qubit`. |
