...
| Figure 9 | `fig_3_12_qae_vs_nonqae_std_loglog` | `figures/fig_3_12_qae_vs_nonqae_std_loglog.png` | `final_figure/refer_pre_paper/qae_fft_1d_context/qae_vs_nonqae_std_loglog.png` |
| Figure 10 | `fig_4_1_first_compton_local_deposition_geant4_6mev_water_500k_depth170_v3` | `figures/fig_4_1_first_compton_local_deposition_geant4_6mev_water_500k_depth170_v3.png` | `experiments/geant4_depthdose_fig14/run_geant4_first_compton_depthdose.py` |
| Figure 11 | `fig_4_1b_second_compton_fixed_lambda_geant4_6mev_water_500k_depth170_v2` | `figures/fig_4_1b_second_compton_fixed_lambda_geant4_6mev_water_500k_depth170_v2.png` | `experiments/geant4_depthdose_fig14/run_geant4_second_compton_fixed_lambda_depthdose.py` |
| Figure 12 | `fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10_v2` | `figures/fig_3_14_q50_stateprep_fft_chebyshev_dose_seed10_v2.png` | `experiments/stateprep_qmci_seed10/render_figures_12_13_stateprep_qmci.py` |
...
Figure 6-a and Figure 6-b use the manuscript-current state-preparation ansatz:
...
1. Regenerate current Figure 6-a and Figure 6-b with:
