...
| `fig_3_2b_stateprep_matched_reps_q5_seed10` | Figure 4-a seed10 matched q50 reps diagnostic with lower method label and reduced full-width info label | OK | `figures/fig_3_2b_stateprep_matched_reps_q5_seed10.png` |
