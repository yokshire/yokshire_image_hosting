...
| `fig_3_9_qae_fft_data_qubit_convergence_v1` | Current Figure 9 q40/q50/q60 FFT state-prep QMCI/QAE convergence using the checked `accuracy_num_qmc.ipynb` reference definition | OK | `figures/fig_3_9_qae_fft_data_qubit_convergence_v1.png` |
